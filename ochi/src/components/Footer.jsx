...
const Footer = () => {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed='.2'
      className='flex gap-5 w-full min-h-screen h-screen bg-zinc-900 py-20 px-20'
    >
      <div className='w-1/2 founders-grotex h-full flex flex-col justify-between'>
        <div className='heading'>
          <h1 className='text-[8vw] uppercase leading-none -mb-4'>Eye-</h1>
      ...
      <div className='w-1/2'>
        <h1 className='text-[7vw] founders-grotex uppercase leading-none -mb-4'>
          Presentations
        </h1>
