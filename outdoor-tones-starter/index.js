class App {
  ...
  _createIntro() {
    ...
    tl.to('.hero__title div', {
      ...
      .to(
        ...
        0.5 //this assures that this runs after 0.5 second of the first starting of the timeline
      );
  }
  ...
  _createHero() {
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: '.hero',
        start: 'top top', //when the top of the hero reaches the top of the viewport
        end: 'bottom top', //when the bottom of the hero reached the top of the viewport
        scrub: true,
        // markers: true,
      },
    });
